...
router.get("/photos/:photoId", /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return req.context.models.Comment.findByPhotoId(req.params.photoId);

          case 2:
            comment = _context.sent;
            return _context.abrupt("return", res.send(comment));
